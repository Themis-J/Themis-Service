...
CREATE_ALL_TABLES_SQL_PATH=$DATABASE_INSTALL_PKG_PATH/1_create_themis_tables.sql
echo "Installing new tables..."
psql -h $DATABASE_SERVER -f $CREATE_ALL_TABLES_SQL_PATH -U $DATABASE_USER $DATABASE_NAME

INSERT_INIT_DATA_SQL_PATH=$DATABASE_INSTALL_PKG_PATH/2_insert_themis_data.sql
